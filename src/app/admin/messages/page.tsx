          ...
          <div className="relative rounded-3xl overflow-hidden bg-gradient-to-br from-brand-violet-900 via-brand-purple-800 to-brand-purple-900 border-2 border-brand-gold-400/40 p-6 md:p-8 shadow-2xl mb-6">
            ...
            <div className="relative z-10">
              ...
              <div className="flex items-center gap-2 text-sm mb-4">
                ...
                <span className="text-brand-gold-400 font-semibold">Messages</span>
              </div>
              ...
              <div className="flex items-start justify-between flex-wrap gap-4">
                ...
                <div className="flex flex-wrap gap-3">
                  <div className="px-4 py-2 rounded-2xl bg-brand-purple-950/60 border border-brand-gold-400/40">
                    ...
                    <p className="text-2xl font-heading font-black text-white">{allMessages.length}</p>
                  </div>
                  {unreadCount > 0 && (
                  ...
                  {archivedCount > 0 && (
                    <div className="px-4 py-2 rounded-2xl bg-brand-purple-950/60 border border-brand-gold-400/40">
                      <p className="text-xs text-brand-purple-200 uppercase tracking-widest font-semibold">Archived</p>
                      <p className="text-2xl font-heading font-black text-white">{archivedCount}</p>
                    </div>
                  )}
                </div>
              </div>
