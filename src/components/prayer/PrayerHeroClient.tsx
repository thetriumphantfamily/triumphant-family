// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// PRAYER HERO CLIENT — White gradient + no top icon
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
interface PrayerHeroClientProps {
  photos: string[];
}

export default function PrayerHeroClient({ photos }: PrayerHeroClientProps) {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-gradient-to-br from-brand-violet-900 via-brand-purple-800 to-brand-purple-900 min-h-[380px] sm:min-h-[420px] lg:min-h-[520px] flex items-center">
      ...
      <div className="relative z-20 container-custom text-center py-10 lg:py-16 w-full">
        ...
        <p className="text-brand-purple-200 text-sm font-semibold mb-4 lg:mb-6">
          — Matthew 18:19
        </p>
        ...
        <nav className="flex items-center justify-center gap-2 text-sm text-brand-purple-200">
          ...
          <span className="text-white font-semibold">Prayer</span>
        </nav>
      </div>
    </section>
  );
