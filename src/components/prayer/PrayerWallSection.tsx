// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// PRAYER WALL — White gradient + white CTAs + tight spacing
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
        ...
        {prayers && prayers.length > 0 && (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 max-w-7xl mx-auto">
            {prayers.map((prayer) => (
              <div
                key={prayer.id}
                className="group relative bg-gradient-to-br from-brand-violet-900 via-brand-purple-800 to-brand-purple-900 rounded-2xl p-5 border border-brand-gold-400/40 hover:border-brand-gold-400 transition-all duration-300 hover:-translate-y-0.5 flex flex-col overflow-hidden"
              >
                <div className="absolute top-0 inset-x-0 h-0.5 bg-gradient-to-r from-brand-gold-300 via-brand-gold-400 to-brand-gold-500" />

                {/* Category + answered badge — WHITE */}
                <div className="relative z-10 flex items-center justify-between gap-2 mb-3 pt-0.5">
                  <span className="px-2.5 py-0.5 rounded-full bg-brand-purple-950/60 border border-white/20 text-white text-[10px] font-bold">
                    {CATEGORY_LABELS[prayer.category] || "🙏 Prayer"}
                  </span>

                  {prayer.is_answered && (
                    <span className="px-2 py-0.5 rounded-full bg-green-500/20 border border-green-400/40 text-green-300 text-[10px] font-bold flex items-center gap-1">
                ...
                {/* Prayer text */}
                <p className="relative z-10 text-brand-purple-100 leading-relaxed text-sm flex-1 mb-4">
                  {prayer.prayer_point}
                </p>
                ...
                {/* Pray button — WHITE gradient */}
                <Link
                  href="/prayer#form"
                  className="relative z-10 w-full mt-3 inline-flex items-center justify-center gap-1.5 px-4 py-2 rounded-full bg-gradient-to-r from-white to-gray-100 text-brand-purple-900 font-bold text-xs shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300"
                >
