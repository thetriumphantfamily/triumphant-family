...
interface GalleryHeroClientProps {
  photos: string[];
}

export default function GalleryHeroClient({ photos }: GalleryHeroClientProps) {
      ...
      <div className="relative z-20 container-custom text-center py-10 lg:py-24 w-full">
        ...
        <div className="flex justify-center mb-4">
          <div className="inline-flex items-center gap-2 px-5 py-2 lg:px-6 lg:py-2.5 rounded-full bg-gradient-to-br from-brand-violet-900 via-brand-purple-800 to-brand-purple-900 border border-brand-gold-400/40 shadow-lg">
            ...
            <span className="text-white font-bold text-xs lg:text-sm uppercase tracking-widest">Precious Moments</span>
          </div>
        </div>

        <h1 className="font-heading text-2xl md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-3 lg:mb-4">
          Ministry{" "}
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-gold-300 via-brand-gold-400 to-brand-gold-200">Gallery</span>
        </h1>
        ...
        <p className="text-brand-purple-100 text-sm md:text-base lg:text-lg max-w-2xl mx-auto leading-relaxed mb-5 lg:mb-6 px-2 sm:px-0">
          Relive glorious moments from our services, prayer meetings, events, and outreach programs. Every picture tells a story of God&rsquo;s faithfulness.
        </p>
        ...
        <p className="font-script text-brand-gold-400 text-lg md:text-2xl mb-6 lg:mb-8">Captured by grace. Preserved in love.</p>
