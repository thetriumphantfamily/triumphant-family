    ...
    try {
      ...
      if (student.status === "rejected") {
        setStatusMessage({
          ...
          message:
            "Your registration was not approved. Please contact the school administrator for more information at thetriumphantgrace@gmail.com",
        });
        setIsSubmitting(false);
        return;
      }
      ...
      // For approved students, we'll do simple password check
      // (In production, use proper hashing. For now, storing plain is ok since
      // we're using localStorage session tracking)
    ...
    return (
      <div className="max-w-md mx-auto">
        <div className="relative bg-gradient-to-br from-brand-violet-900 via-brand-purple-800 to-brand-purple-900 rounded-3xl p-6 md:p-8 border-2 border-brand-gold-400/40 shadow-2xl text-center">
          ...
          {/* Status Icon */}
          <div
            className={`inline-flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-br ${bgColor} shadow-lg mb-4`}
          >
            <svg
    ...
    <div className="max-w-md mx-auto">
      ...
      >
        ...
        <div className="space-y-5">
          ...
          <div className="text-right">
            <Link
              ...
              className="text-brand-gold-400 text-sm font-semibold hover:underline"
            >
              Forgot password?
            </Link>
          </div>
        ...
        <div className="mt-6 pt-6 border-t border-brand-gold-400/30 text-center">
          <p className="font-script text-brand-gold-400 text-lg mb-1">
