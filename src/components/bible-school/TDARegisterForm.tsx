...
export default function TDARegisterForm() {
  ...
  const generateStudentId = async (): Promise<string> => {
    ...
    // Get count of students to generate next number
      ...
      <div className="max-w-2xl mx-auto">
        <div className="relative bg-gradient-to-br from-brand-violet-900 via-brand-purple-800 to-brand-purple-900 rounded-3xl p-8 md:p-12 border-2 border-brand-gold-400/40 shadow-2xl text-center">
          ...
          <div className="bg-brand-gold-400/10 border border-brand-gold-400/30 rounded-2xl p-5 mb-6 text-left">
            <p className="font-bold text-brand-gold-400 mb-2">📋 What's Next?</p>
      ...
      >
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4">
            {previewUrl ? (
              ...
              <img
                src={previewUrl}
                alt="Preview"
                className="w-32 h-32 rounded-2xl object-cover border-2 border-brand-gold-400 shadow-gold"
              />
            ) : (
              <div className="w-32 h-32 rounded-2xl bg-brand-purple-950/60 border-2 border-dashed border-brand-gold-400/40 flex items-center justify-center">
                <svg
                  className="w-12 h-12 text-brand-gold-400/40"
                  fill="none"
                  stroke="currentColor"
                  strokeWidth={1.5}
                  viewBox="0 0 24 24"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-bold text-white mb-2">
                Full Name <span className="text-brand-gold-400">*</span>
              </label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-sm font-bold text-white mb-2">
                Phone Number <span className="text-brand-gold-400">*</span>
              </label>
              <input
                type="tel"
            ...
            <div>
              <label className="block text-sm font-bold text-white mb-2">
                Gender <span className="text-brand-gold-400">*</span>
              </label>
              <select
        ...
        <div className="mb-8 pb-6 border-b border-brand-gold-400/30">
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-sm font-bold text-white mb-2">
                Course Level <span className="text-brand-gold-400">*</span>
              </label>
              <select
        ...
        <div className="mb-8 pb-6 border-b border-brand-gold-400/30">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-bold text-white mb-2">
                Confirm Password <span className="text-brand-gold-400">*</span>
              </label>
              <div className="relative">
                <input
        ...
        <div className="mb-6">
          <label className="flex items-start gap-3 cursor-pointer">
            ...
            <span className="text-brand-purple-100 text-sm leading-relaxed">
              ...
              and commit to attending classes, submitting assignments, and
