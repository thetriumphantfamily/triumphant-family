...
const NAV_ITEMS = [
  ...
  { name: "Church Chat", href: "/member/church-chat", icon: "💬", hasCount: false },
  ...
  { name: "Settings", href: "/member/settings", icon: "⚙️", hasCount: false },
];
            ...
            {NAV_ITEMS.map((item) => {
              ...
              return (
                <Link
                  ...
                  onClick={() => {
                    setMobileOpen(false);
                    if (item.hasCount && member?.id) loadUnreadCount(member.id);
                  }}
