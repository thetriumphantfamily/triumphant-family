// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// MEMBER ANNOUNCEMENTS — Dashboard pattern (white IMPORTANT badge)
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
"use client";
    ...
    <div className="space-y-6">
      ...
      <div className="relative rounded-3xl overflow-hidden bg-gradient-to-br from-brand-violet-900 via-brand-purple-800 to-brand-purple-900 border-2 border-brand-gold-400/40 p-6 md:p-8 shadow-2xl">
        ...
        <div className="relative z-10">
          ...
          <h1 className="font-heading text-2xl md:text-3xl lg:text-4xl font-bold text-white mb-3 leading-tight">Church Notices</h1>
          <p className="text-brand-purple-100 text-sm md:text-base">Stay updated with the latest news and ministry updates</p>
      ...
      {announcements.length === 0 && (
        <div className="relative rounded-3xl overflow-hidden bg-gradient-to-br from-brand-violet-900 via-brand-purple-800 to-brand-purple-900 border-2 border-brand-gold-400/40 p-8 shadow-xl text-center">
          ...
          <h2 className="font-heading text-xl font-bold text-white mb-2">No Announcements Yet</h2>
          <p className="text-brand-purple-200 text-sm">When new updates are posted, they will appear here.</p>
        </div>
      )}
            ...
            return (
              <button
                ...
                className={`w-full text-left relative rounded-3xl overflow-hidden bg-gradient-to-br from-brand-violet-900 via-brand-purple-800 to-brand-purple-900 border-2 p-5 shadow-xl transition-all hover:-translate-y-0.5 ${
                  isOpen ? "border-brand-gold-400" : a.is_important ? "border-brand-gold-400/60" : "border-brand-gold-400/40 hover:border-brand-gold-400/70"
                }`}
              >
                <div className="absolute top-0 inset-x-0 h-0.5 bg-gradient-to-r from-brand-gold-300 via-brand-gold-400 to-brand-gold-500" />
                ...
                <p className={`text-white/80 font-semibold text-sm whitespace-pre-wrap text-justify ${isOpen ? "" : "line-clamp-2"}`}>
                  {a.body}
                </p>

                {isOpen && (
                  <div className="mt-4 pt-3 border-t border-brand-gold-400/30">
                    <p className="text-brand-purple-300 text-xs font-semibold">📅 Posted: {formatDateFull(a.created_at)}</p>
                  </div>
                )}

                {!isOpen && a.body.length > 120 && (
                  <p className="text-brand-purple-300 text-xs font-bold mt-2">Tap to read more →</p>
                )}
              </button>
            );
          })}
