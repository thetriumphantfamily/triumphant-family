// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// MEMBER TESTIMONIES — Share testimonies + notify admin
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
"use client";
...
export default function MemberTestimoniesClient() {
  ...
  useEffect(() => {
    loadMemberAndTestimonies();
  }, []);

  const loadMemberAndTestimonies = async () => {
    let foundId = "";
    let foundName = "";
    ...
    <div className="space-y-6">
      <div className="relative rounded-3xl overflow-hidden bg-gradient-to-br from-brand-violet-900 via-brand-purple-800 to-brand-purple-900 border-2 border-brand-gold-400/40 p-6 md:p-8 shadow-2xl">
        ...
        <div className="relative z-10">
          ...
          <div className="flex gap-4 pt-4 mt-4 border-t border-brand-gold-400/30">
            <div className="text-center">
              <p className="text-white font-black text-2xl">{testimonies.length}</p>
            ...
            <div className="text-center">
              <p className="text-white font-black text-2xl">{approvedCount}</p>
              <p className="text-brand-purple-200 text-xs font-semibold uppercase tracking-widest">Approved</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {testimonies.length === 0 ? (
        <div className="relative rounded-3xl overflow-hidden bg-gradient-to-br from-brand-violet-900 via-brand-purple-800 to-brand-purple-900 border-2 border-brand-gold-400/40 p-8 shadow-xl text-center">
          ...
          <p className="text-brand-purple-200 text-sm">Share what God has done for you!</p>
        </div>
      ) : (
        <div className="space-y-3">
          {testimonies.map((t) => (
            <div key={t.id} className={`relative rounded-3xl overflow-hidden bg-gradient-to-br from-brand-violet-900 via-brand-purple-800 to-brand-purple-900 border-2 ${t.is_approved ? "border-green-400/40" : "border-brand-gold-400/40"} p-5 shadow-xl`}>
              <div className="absolute top-0 inset-x-0 h-0.5 bg-gradient-to-r from-brand-gold-300 via-brand-gold-400 to-brand-gold-500" />
              ...
              <p className="text-white font-black text-lg mb-2">{t.title}</p>
