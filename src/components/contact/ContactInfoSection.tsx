// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// CONTACT INFO — Email now opens Gmail compose
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
const CONTACT_METHODS = [
  ...
  },
  {
    ...
    action:      "https://mail.google.com/mail/?view=cm&fs=1&to=thetriumphantgrace@gmail.com&su=Hello%20from%20your%20website",
      ...
      <div className="relative z-10 container-custom">
        ...
        <div className="text-center mb-10 max-w-3xl mx-auto">
          ...
          <p className="text-brand-purple-100 text-sm md:text-base lg:text-lg leading-relaxed">
            Choose your preferred way to connect with us. We&rsquo;re here for you.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
          {CONTACT_METHODS.map((method) => (
            <a
              ...
              className="group relative bg-gradient-to-br from-brand-violet-900 via-brand-purple-800 to-brand-purple-900 rounded-2xl p-6 border border-brand-gold-400/40 hover:border-brand-gold-400 hover:shadow-[0_0_25px_rgba(255,199,44,0.25)] transition-all duration-300 hover:-translate-y-1 overflow-hidden"
            >
              {/* Gold top bar */}
              ...
              <div className="relative z-10">
                ...
                {/* Detail */}
                <p className="text-brand-gold-400 font-bold text-sm mb-2 break-all">
                  {method.detail}
                </p>

                {/* Description */}
                <p className="text-brand-purple-200 text-xs">{method.description}</p>
              </div>
            </a>
          ))}
        </div>
