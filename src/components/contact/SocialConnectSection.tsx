  ...
  return (
    <section className="py-16 lg:py-24 bg-gray-50">
      <div className="container-custom">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 max-w-4xl mx-auto">
          {SOCIAL_PLATFORMS.map((platform) => (
            <a
              ...
              className="group bg-white rounded-2xl p-6 text-center border-2 border-gray-100 hover:border-brand-gold-400 hover:shadow-gold transition-all duration-300 hover:-translate-y-2"
            >
              {/* Icon */}
              <div
                className={`inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br ${platform.color} text-white mb-4 shadow-lg group-hover:scale-110 transition-transform duration-300`}
              >
                {platform.icon}
              </div>
        ...
        {/* Bottom tagline */}
        <p className="text-center mt-10 font-script text-brand-purple-600 text-xl md:text-2xl">
