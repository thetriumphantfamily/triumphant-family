// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// BANK DETAILS SECTION — Full purple themed UBA card with copy button
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  return (
    <section className="py-16 lg:py-24 bg-white">
      <div className="container-custom">
        ...
        {/* Bank Card — FULL PURPLE THEME */}
        <div className="max-w-2xl mx-auto">
          <div className="relative rounded-3xl overflow-hidden shadow-2xl bg-gradient-to-br from-brand-violet-900 via-brand-purple-800 to-brand-purple-900 border-2 border-brand-gold-400/30">
            {/* Decorative blobs */}
            <div className="absolute top-[-20%] right-[-15%] w-80 h-80 rounded-full bg-brand-magenta-500/25 blur-3xl pointer-events-none" />
            <div className="absolute bottom-[-20%] left-[-15%] w-80 h-80 rounded-full bg-brand-gold-400/15 blur-3xl pointer-events-none" />

            <div className="relative z-10 p-8 md:p-10">
              {/* Header — UBA + Bank name */}
              ...
              <div className="mb-8">
                ...
                <div className="flex items-center gap-4 flex-wrap">
                  ...
                  <button
                    onClick={handleCopy}
                    className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-br from-brand-gold-400 to-brand-gold-500 hover:from-brand-gold-500 hover:to-brand-gold-600 text-brand-purple-900 text-sm font-bold shadow-gold hover:shadow-gold-lg hover:scale-105 transition-all duration-300"
                  >
                    {copied ? (
                      <>
                        <svg
              ...
              {/* Follow-up note — All purple/gold theme */}
              <div className="flex items-start gap-3 bg-white/5 backdrop-blur-sm rounded-2xl p-4 border border-brand-gold-400/30">
