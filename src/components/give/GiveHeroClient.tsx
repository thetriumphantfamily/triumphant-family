// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// GIVE HERO CLIENT — White gradient + no top icon + tight spacing
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
interface GiveHeroClientProps {
  photos: string[];
}

export default function GiveHeroClient({ photos }: GiveHeroClientProps) {
    ...
    <>
      {photos.map((src, i) => (
        <div key={src} className={`absolute inset-0 transition-opacity duration-1000 ${i === currentIndex ? "opacity-100" : "opacity-0"}`}>
          <img src={src} alt="Give" loading={i === 0 ? "eager" : "lazy"} className="w-full h-full object-cover object-top" />
        </div>
      ))}
    </>
  );
      ...
      <div className="relative z-20 container-custom text-center py-10 lg:py-16 w-full">
        ...
        <div className="flex justify-center mb-4">
          <div className="inline-flex items-center gap-2 px-5 py-2 lg:px-6 lg:py-2.5 rounded-full bg-gradient-to-br from-brand-violet-900 via-brand-purple-800 to-brand-purple-900 border border-brand-gold-400/40 shadow-lg">
            ...
            <span className="text-white font-bold text-xs lg:text-sm uppercase tracking-widest">Partner With Us</span>
          </div>
        </div>
        ...
        <p className="text-brand-purple-100 text-sm md:text-base lg:text-lg max-w-2xl mx-auto leading-relaxed mb-4 lg:mb-6 px-2 sm:px-0">
          Every seed sown into this ministry advances the Kingdom of God, transforms lives, and releases the anointing to more nations. Give cheerfully and expect a divine harvest.
        </p>
        ...
        {/* Scripture */}
        <p className="font-heading italic font-bold text-brand-gold-400 text-base md:text-lg lg:text-xl max-w-3xl mx-auto leading-relaxed mb-2 px-2 sm:px-0">
        ...
        <p className="text-brand-purple-200 text-sm font-semibold mb-4 lg:mb-6">— 2 Corinthians 9:7</p>
        ...
        <nav className="flex items-center justify-center gap-2 text-sm text-brand-purple-200">
          ...
          <span className="text-white font-semibold">Give</span>
        </nav>
      </div>
    </section>
  );
