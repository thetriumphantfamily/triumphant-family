// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// SERVICE TIMES SECTION — Tight spacing + white 3D icons + white buttons
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  return (
    <section className="relative pt-8 pb-10 lg:pt-10 lg:pb-12 bg-gradient-to-br from-brand-violet-900 via-brand-purple-800 to-brand-purple-900 overflow-hidden">
      ...
      <div className="relative z-10 container-custom">
        ...
        {/* Heading */}
        <div className="text-center mb-6 lg:mb-8 max-w-5xl mx-auto">
        ...
        {/* 4 EQUAL CARDS */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-6 max-w-6xl mx-auto mb-6">

          {/* CARD 1: LOCATION */}
          <div className="group bg-gradient-to-br from-brand-violet-900 via-brand-purple-800 to-brand-purple-900 border-2 border-brand-gold-400/40 hover:border-brand-gold-400 rounded-3xl p-5 lg:p-6 transition-all duration-300 relative overflow-hidden">
            ...
            <div className="flex items-start gap-4 h-full">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between mb-2 flex-wrap gap-2">
                  ...
                  <span className="px-2.5 py-0.5 rounded-full bg-brand-purple-950/60 border border-white/20 text-white text-[10px] font-bold uppercase tracking-wider">
                    Sunday
                  </span>
                </div>
                <p className="text-white font-heading font-bold text-xl lg:text-2xl mb-2 flex items-center gap-2">
        ...
        <div className="flex flex-col sm:flex-row gap-3 lg:gap-4 justify-center max-w-md mx-auto">
          ...
          <Link
            href="/live"
            className="flex-1 inline-flex items-center justify-center gap-2 px-6 py-3 rounded-full bg-gradient-to-r from-white to-gray-100 text-brand-purple-900 font-bold text-base shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300"
          >
