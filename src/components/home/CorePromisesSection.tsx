// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// CORE PROMISES SECTION — Tight spacing, smaller icons
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    ...
    <section className="relative pt-8 pb-10 lg:pt-10 lg:pb-12 bg-gradient-to-br from-brand-violet-900 via-brand-purple-800 to-brand-purple-900 overflow-hidden">
      ...
      <div className="relative z-10 container-custom">
        ...
        <div className="text-center mb-6 lg:mb-8">
          ...
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-6 py-2.5 rounded-full bg-gradient-to-br from-brand-violet-900 via-brand-purple-800 to-brand-purple-900 border border-brand-gold-400/40 shadow-lg mb-4">
          ...
          {/* Heading */}
          <h2 className="font-heading text-3xl md:text-4xl lg:text-6xl font-bold text-white leading-tight mb-3">
            God&rsquo;s Best{" "}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6">
          {PROMISES.map((promise, index) => (
            <div
              key={index}
              className="group relative bg-gradient-to-br from-brand-violet-900 via-brand-purple-800 to-brand-purple-900 rounded-3xl p-5 lg:p-6 border-2 border-brand-gold-400/40 hover:border-brand-gold-400 transition-all duration-500 hover:-translate-y-2 overflow-hidden shadow-xl"
            >
              ...
              {/* Icon — smaller, WHITE 3D METALLIC */}
              <div
