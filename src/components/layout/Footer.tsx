// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// FOOTER — Clean 3D + colored social icons + straight icons
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    ...
    <footer className="bg-gradient-to-b from-brand-purple-900 to-brand-purple-950 text-white">
      ...
      <div className="container-custom py-12 md:py-14">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div>
            <h3 className="font-body font-black text-lg mb-5 uppercase tracking-wide" style={HEADING_3D_STYLE}>
              Connect With Us
            </h3>
            <div className="flex flex-col gap-3">
              {/* Facebook — RESTORED colored */}
              <a
              ...
              >
                ...
                <span className="text-brand-purple-200 text-sm group-hover:text-white transition-colors">
                  Facebook
                </span>
              </a>

              {/* YouTube — RESTORED colored */}
              <a
          ...
          <div>
            ...
            <div className="flex items-start gap-3 mb-4">
              <Clock className="w-5 h-5 flex-shrink-0 mt-0.5" style={ICON_STYLE} />
              <div>
                ...
                {SERVICES.map((service) => (
                  <p key={service.day} className="text-brand-purple-200 text-sm">
                    <span className="text-white font-semibold">{service.day}:</span>{" "}
                    {service.time}
                  </p>
                ))}
              </div>
            ...
            <div className="flex items-start gap-3 mb-3">
              <MapPin className="w-5 h-5 flex-shrink-0 mt-0.5" style={ICON_STYLE} />
              <p className="text-brand-purple-200 text-sm">{CONTACT.address.full}</p>
            </div>

            <a
              href={`tel:${CONTACT.phoneRaw}`}
              className="flex items-center gap-3 mb-3 text-brand-purple-200 hover:text-white transition-colors"
            >
              <Phone className="w-5 h-5 flex-shrink-0" style={ICON_STYLE} />
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-3 text-brand-purple-200 hover:text-white transition-colors break-all"
            >
              <Mail className="w-5 h-5 flex-shrink-0" style={ICON_STYLE} />
      ...
      <div className="border-t border-white/10 py-5">
        <div className="container-custom flex flex-col items-center gap-2 text-center">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-brand-purple-300 text-xs hover:opacity-80 transition-all inline-flex items-center gap-1"
          >
            Powered by{" "}
            <span
              className="font-body font-black text-white"
              style={HEADING_3D_STYLE}
            >
