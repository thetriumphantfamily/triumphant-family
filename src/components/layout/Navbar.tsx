...
const SOCIAL_LINKS = [
  ...
  },
  {
    ...
    bg:    "bg-gradient-to-br from-red-600 to-red-700 hover:from-red-500 hover:to-red-600",
    svg: (
  ...
  },
  {
    ...
    bg:    "bg-gradient-to-br from-gray-900 to-black hover:from-gray-800 hover:to-gray-900",
    svg: (
      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex items-center gap-2 pr-3 border-r border-white/20">
              {SOCIAL_LINKS.map((social) => (
                <a
                  ...
                  title={social.name}
                  className={cn(
                    "w-8 h-8 rounded-full text-white flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-md",
                    social.bg
                  )}
                >
                  {social.svg}
              ...
              <div className="flex items-center justify-center gap-3">
                {SOCIAL_LINKS.map((social) => (
                  <a
                    ...
                    aria-label={`Follow on ${social.name}`}
                    className={cn(
                      "w-11 h-11 rounded-full text-white flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-md",
                      social.bg
                    )}
                  >
                    {social.svg}
